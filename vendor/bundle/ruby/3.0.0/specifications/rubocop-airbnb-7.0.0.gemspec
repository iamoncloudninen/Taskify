# -*- encoding: utf-8 -*-
# stub: rubocop-airbnb 7.0.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<rubocop-performance>.freeze, ["~> 1.20"])
    s.add_runtime_dependency(%q<rubocop-rails>.freeze, ["~> 2.24"])
    s.add_runtime_dependency(%q<rubocop-rspec>.freeze, ["~> 2.26"])
    s.add_development_dependency(%q<rspec>.freeze, ["~> 3.5"])
  else
    s.add_dependency(%q<rubocop>.freeze, ["~> 1.61"])
    s.add_dependency(%q<rubocop-performance>.freeze, ["~> 1.20"])
    s.add_dependency(%q<rubocop-rails>.freeze, ["~> 2.24"])
    s.add_dependency(%q<rubocop-rspec>.freeze, ["~> 2.26"])
